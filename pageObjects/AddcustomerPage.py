...
class AddCustomer():
    ...
    txtcustomerRoles_css = "#customer-info > div.panel-container > div.panel-body > div:nth-child(10) > div.col-md-9 > div > div.k-widget.k-multiselect.k-multiselect-clearable > div"
    ...
    def setCustomerRoles(self, role):
        self.driver.find_element_by_css_selector(self.txtcustomerRoles_css).click()
        time.sleep(3)
        if role == 'Registered':
